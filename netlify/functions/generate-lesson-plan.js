...
const MILESTONES = [
  ...
  { number: 17, name: "Serve Zones", description: "Hit right and left side of service box on both sides (4 serves in 10 tries)", category: "Advanced Beginner" },
  ...
  { number: 20, name: "Big Hitter", description: "Hit a clean winner from the baseline", category: "Advanced Beginner" },
