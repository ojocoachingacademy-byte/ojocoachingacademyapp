...
import { LogOut, LayoutDashboard, Calendar, Users, MessageSquare, Settings, DollarSign, Receipt, UserCheck, ThumbsUp } from 'lucide-react'
                ...
                Dashboard
                  ...
                  {isCoach ? (
                    <>
                      ...
                      <button 
                        className={`nav-link ${isActive('/coach/testimonials') ? 'active' : ''}`}
